...
//
// ## Disclaimer
// This implementation is most definitively not as efficient/complete/advanced/... (fill in the blanks!) as those entering the [SAT competition](http://www.satcompetition.org/). 
//
// ## Why JavaScript?
...
//
// ## Tests
// This library comes with its unit tests written with [mocha](http://visionmedia.github.io/mocha). To run them simply head to the `test` 
...
//
// In other words you want to know the values of `a`, `b`, `c`, `d` and `e` that make this formula `true`. Here's how you do it with **DPLL.js**:
//     
