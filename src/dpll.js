// # DPLL.js
// 
// An implementation of the Davis-Putnam-Logemann-Loveland ([DPLL](http://en.wikipedia.org/wiki/DPLL_algorithm)) algorithm 
// for solving the [CNF-SAT](http://en.wikipedia.org/wiki/Boolean_satisfiability_problem) problem that runs on [Node.js](http://nodejs.org).
// 
...
// 
// The [DPPL.js source](https://github.com/ofmooseandmen/DPLL.js) is available on GitHub, and is released under the MIT license.
//
// Most of this documentation actually comes from [wikipedia](http://en.wikipedia.org) and is generated by [docco](http://jashkenas.github.io/docco/)
//
// ## Disclaimer
// This implementation is most definitively not as efficient as those entering the [SAT competition](http://www.satcompetition.org/). 
//
// ## Why JavaScript?
...
//
// ## Tests
// This library comes with its unit test written with [mocha](http://visionmedia.github.io/mocha). To run them simple head to the `test` 
// directory and execute `mocha *Test.js`
//
// ## Usage
// Let's say you want to solve the following formula: ` (a | b) & (-b | c | -d) & (d | -e) `. In other world you'd like to know
// the value of `a`, `b`, `c`, `d` and `e` that would make this formula `true`. All you need to do is:
//     
...
// 
// - variable with highest occurrence amongst the unassigned variables; enabled by calling `Solver#highestOccurrenceVariableSelection`
// 
